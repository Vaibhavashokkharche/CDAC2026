...
public class TestManytoMany {
	...
	public static void main(String[] args) {
		...
		Person p1=new Person(11,"Rakesh","4444",null);
		Person p2=new Person(12,"Bhavika","55555",null);
		Address a1=new Address(100,"Baner","Pune","Maharashtra",null);
		Address a2=new Address(101,"Aundh","Pune","Maharashtra",null);
		Address a3=new Address(103,"Wakad","Pune","Maharashtra",null);
