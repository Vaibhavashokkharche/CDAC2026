...
public class ProductController {
	...
	static String upload_folder = "C:/Users/vaibh/images/";
	...
	public String addnewproduct(Model model) {
		...
		System.out.println("in modelattribute after");

		return "addproduct";
	}

	@PostMapping("/save")
	public String insertNewProduct(@Valid @ModelAttribute("product") Product product, BindingResult result ,@RequestParam("image") MultipartFile file) throws IllegalStateException, IOException {
...
System.out.println("original file name :" +fileName);
		      // String path =servletContext.getRealPath("/uploads/");
		       ...
		       // Files.createDirectories(Paths.get(path));     //to create folder programettically
		        ...
		        product.setImagefile(product.getPid()+fileName);
	...
	public String updateProduct(@Valid @ModelAttribute("product") Product product) {
		...
		boolean status = pservice.updateProductById(product);
		if (status) {
